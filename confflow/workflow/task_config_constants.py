...
_KNOWN_CALC_PARAMS_BASE = frozenset({
    ...
    "energy_window", "rmsd_threshold", "noH",
    "dedup_only", "keep_all_topos", "max_conformers", "imag",
    "energy_tolerance", "clean_params", "clean_opts", "auto_clean",
    "gaussian_path", "orca_path", "allowed_executables", "orca_maxcore",
    "blocks", "gaussian_write_chk", "gaussian_modredundant", "gaussian_link0",
    "chk_from_step",
    "ts_bond_atoms", "ts_rescue_scan",
    "ts_bond_drift_threshold", "ts_rmsd_threshold",
...
_EXPLICIT_CALC_CONFIG_FIELDS = frozenset({
    ...
    "charge", "multiplicity", "freeze",
    "energy_window", "rmsd_threshold", "noH",
    "dedup_only", "keep_all_topos", "energy_tolerance",
    "clean_params", "clean_opts", "auto_clean",
    "allowed_executables", "orca_maxcore",
    "blocks", "gaussian_write_chk", "gaussian_modredundant", "gaussian_link0",
    "chk_from_step",
    "ts_bond_atoms", "ts_rescue_scan",
    "ts_bond_drift_threshold", "ts_rmsd_threshold",
