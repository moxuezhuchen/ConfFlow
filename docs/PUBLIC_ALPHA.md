...
- Release status: v2.0.0 remains the published GitHub Release. The v2.1.0 release workflow is prepared to build and publish wheel/sdist artifacts, checksums, SBOM, release provenance, and build attestation, but v2.1.0 is not tagged or published; PyPI publishing remains manual.
...
- PyPI publishing is not automated. The published v2.0.0 release record remains historical; the v2.1.0 GitHub Release workflow automates release artifact publication, artifact provenance, and build attestation once separately authorized. Full SLSA-style hardening remains a separate limitation.
